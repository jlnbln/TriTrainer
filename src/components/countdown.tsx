...
export function Countdown() {
  ...
  const raceDate = new Date(RACE_DATE + 'T12:00:00Z');
        ...
        <div className="relative z-10">
          ...
          {isPast ? (
            ...
            <>
              ...
              <p className="text-muted-foreground text-sm mb-5">
                {diffWeeks > 0 ? `${diffWeeks} weeks · ` : ''}September 6, 2026
              </p>
            </>
          )}
          ...
          <div className="flex flex-wrap items-center gap-4 border-t border-border/30 pt-4">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-headline font-bold text-sm" style={{ color: 'var(--sport-swim)' }}>1km swim</span>
            </div>
            <div className="w-1 h-1 rounded-full bg-border" />
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined text-lg" style={{ color: 'var(--sport-bike)' }}>directions_bike</span>
              <span className="font-headline font-bold text-sm" style={{ color: 'var(--sport-bike)' }}>20km bike</span>
            </div>
            <div className="w-1 h-1 rounded-full bg-border" />
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined text-lg" style={{ color: 'var(--sport-run)' }}>directions_run</span>
              <span className="font-headline font-bold text-sm" style={{ color: 'var(--sport-run)' }}>5km run</span>
            </div>
          </div>
        </div>
