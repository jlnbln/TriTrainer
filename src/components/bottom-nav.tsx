...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 bg-background border-t border-border/20">
      <div className="flex items-center justify-around h-16 max-w-lg mx-auto px-4 safe-area-pb">
        {navItems.map((item) => {
